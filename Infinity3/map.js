...
clear_home = function() {
  return localStorage.setItem('wu_map_home_deed_14852', '');
};
...
share_deed = function(tag, el) {
  ...
  el.style.padding = 0;
  el.innerHTML = '<input type="text" value="https://andistyr.github.io/wu-map/14852/#' + tag + '" style="width:280px;padding:2px;border-radius:3px;border:1px solid #dedede;font-size:12px" onclick="this.select()" />';
...
share_coords = function(x, y, el) {
  el.style.backgroundColor = 'white';
  el.style.padding = 0;
  el.innerHTML = '<input type="text" value="https://andistyr.github.io/wu-map/14852/#' + x + '_' + y + '" style="width:255px;padding:2px;border-radius:3px;border:1px solid #dedede;font-size:12px" onclick="this.select()" />';
  el.childNodes[0].select();
  return false;
};
