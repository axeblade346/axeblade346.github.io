...
LSADrawline (LSAminAX,LSAminAY,LSAmaxAX,LSAmaxAY,"#00FFFD"); //side A
LSADrawline (LSAminBX,LSAminBY,LSAmaxBX,LSAmaxBY,"#00FFFD"); //side B
...
// REMEMBER to send the color value too
function LSADrawline (LSAxs,LSAys,LSAxe,LSAye,LSAcolor)
{
...
var LSAPath = new google.maps.Polyline({
	  path: LSACoordinates,
	  geodesic: false,
	  strokeColor: LSAcolor,
	  strokeOpacity: 0.8,
	  strokeWeight: 5
	});
LSAPath.setMap(map);
